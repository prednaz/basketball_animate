// library
const transformation_matrix = (origin, target) => target.getScreenCTM().inverse().multiply(origin.getScreenCTM());
const svg_element = (dom_selector, svg_selector) =>
  Array.prototype.concat.apply(
    [],
    Array.prototype.map.call(
      document.querySelectorAll(dom_selector),
      dom_element =>
        Array.from(dom_element.contentDocument.querySelectorAll(svg_selector))
    )
  );
